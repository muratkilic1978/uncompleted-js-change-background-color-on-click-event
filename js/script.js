    ...
    /* Step 4.2 - if currentColor is equal (==) to "red" then write open and end curly brackets. Inside the open and end curly brackets do following. Use document.querySelector to select 'body' element in HTML and set the style.backgroundColor = "green" and finally set the variable currentColor = "green" followed by a semicolon */

    /* Step 4.3 - Write else and after the else keyword write begin and end curly brackets */

    /* Step 4.4 - Inside the curly-brackets use document.querySelector to select 'body' element and set style.backgroundColor = "red" and finally set the currentColor = "red" followed by a semicolon */

    /* Step 4.5 - Place the cursor outside the end-curly brackets from the else-statement and write "return currentColor" followed by a semicolon */